...
=======
        pub fn add_miliseconds(&mut self,seconds:u128) -> Self{
            ...
            if (self.local_time.milisegundos+cant_milisegundos>=86_400_000) {
                cant_dias+=1;
                cant_milisegundos=self.local_time.milisegundos+cant_milisegundos-86_400_000;
            }
            self.local_date.sumar_dias(cant_dias);
...
>>>>>>> Stashed changes
    ...
    impl LocalDate{
        ...
        pub fn cant_milisegundos(&self) ->Timestamp{
            let milisegundos_en_un_dia = 86_400_000; 
            self.cant_dias() * milisegundos_en_un_dia
        }
    ...
    impl ClubSemRust {
        ...
        fn new_priv(duenio_account_id:AccountId, cant_pagos_consecutivos_sin_atrasos_necesarios_para_descuento:u32,mut porcentaje_de_descuento_por_bonificacion:u32,politica_de_autorizacion_activada:bool)->Self{
            ...
            csr.fecha_de_la_ultima_actualizacion = csr.ahora(); 
        ...
        fn crear_cuota_para_socio(&mut self, socio_id:u128, fecha_de_vencimiento:Timestamp) -> Result<(),Error>{
            if !self.tiene_permiso() {return Err(Error::NoSePoseenLosPermisosSuficientes);}
            if !self.existe_socio_con_id(socio_id) {return Err(Error::SocioNoRegistrado)}
...
>>>>>>> Stashed changes
            ...
            self.fecha_de_la_ultima_actualizacion = ahora;
            Ok(())
        }
...
/// Examples -> https://github.com/paritytech/ink-examples/blob/main/erc20/lib.rs
    ...
    mod tests {
        ...
        fn test_actualizacion_mensual(){
            ...
            // Forzamos a que ya sea momento de otra actualizacion, restando los milisegundos en un mes a la fecha de la ultima actualizacion
            club.fecha_de_la_ultima_actualizacion-= 2_678_400_000; // cantidad milisegundos en un mes
